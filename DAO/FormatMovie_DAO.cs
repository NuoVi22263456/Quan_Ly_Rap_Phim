...
namespace DAO
{
    public class FormatMovie_DAO
    {
        public static List<FormatMovie_DTO> GetListFormatMovieByMovie(string movieID)
        {
            List<FormatMovie_DTO> listFormat = new List<FormatMovie_DTO>();
            ...
            {
                FormatMovie_DTO format = new FormatMovie_DTO(row);
        ...
        public static FormatMovie_DTO GetFormatMovieByName(string movieName, string screenTypeName)
        {
            ...
            return new FormatMovie_DTO(data.Rows[0]);
        }
        public static List<FormatMovie_DTO> GetFormatMovie()
        {
            List<FormatMovie_DTO> formatMovieList = new List<FormatMovie_DTO>();
            ...
            {
                FormatMovie_DTO formatMovie = new FormatMovie_DTO(item);
