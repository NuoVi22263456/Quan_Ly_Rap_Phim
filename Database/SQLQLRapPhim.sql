...
BEGIN
	...
	VALUES ( @username, '12345', @loaiTK, @idnv )
END
GO
...
INSERT [dbo].[NhanVien] ([id], [HoTen], [NgaySinh], [DiaChi], [SDT], [CMND]) VALUES (N'NV00', N'admin', CAST(N'2003-04-22' AS Date), N'admin', NULL, 123456789)
INSERT [dbo].[NhanVien] ([id], [HoTen], [NgaySinh], [DiaChi], [SDT], [CMND]) VALUES (N'NV01', N'Bán Vé', CAST(N'2002-04-30' AS Date), N'NVBV', NULL, 14725836)

INSERT [dbo].[TaiKhoan] ([UserName], [Pass], [LoaiTK], [idNV]) VALUES (N'admin', N'admin', 1, N'NV00')-- mk hiện thị là admin
INSERT [dbo].[TaiKhoan] ([UserName], [Pass], [LoaiTK], [idNV]) VALUES (N'NhanVien01', N'12345', 2, N'NV01')-- mk hiện thị là 12345

INSERT [dbo].[KhachHang] ([id], [HoTen], [NgaySinh], [DiaChi], [SDT], [CMND], [DiemTichLuy]) VALUES (N'KH01', N'Nguyễn Văn A', CAST(N'2000-05-03' AS Date), N'1120 Le Van Luong, Phuoc Kien, Nha Be, TP.HCM', N'0123456789', 218161554, 0)
INSERT [dbo].[KhachHang] ([id], [HoTen], [NgaySinh], [DiaChi], [SDT], [CMND], [DiemTichLuy]) VALUES (N'KH02', N'Nguyễn Văn B', CAST(N'2003-05-13' AS Date), N'189/40 Bach Dang, Tan Binh, TP.HCM', N'0123456789', 218161564, 0)
INSERT [dbo].[KhachHang] ([id], [HoTen], [NgaySinh], [DiaChi], [SDT], [CMND], [DiemTichLuy]) VALUES (N'KH03', N'Nguyễn Văn B', CAST(N'2003-05-06' AS Date), N'7 Nguyen Kiem, Go Vap, TP.HCM', N'0123456789', 218161654, 0)
...
INSERT [dbo].[Phim] ([id], [TenPhim], [MoTa], [ThoiLuong], [NgayKhoiChieu], [NgayKetThuc], [SanXuat], [DaoDien], [NamSX]) VALUES (N'P01', N'Mai', N'Mai', 150, CAST(N'2024-02-10' AS Date), CAST(N'2024-05-01' AS Date), N'Việt Nam', N'Trấn Thành', 2024)
INSERT [dbo].[Phim] ([id], [TenPhim], [MoTa], [ThoiLuong], [NgayKhoiChieu], [NgayKetThuc], [SanXuat], [DaoDien], [NamSX]) VALUES (N'P02', N'Lật Mặt: Một điều ước', N'Lat Mat Mot dieu uoc', 100, CAST(N'2024-04-29' AS Date), CAST(N'2024-08-01' AS Date), N'Việt Nam', N'Lý Hải', 2024)
INSERT [dbo].[Phim] ([id], [TenPhim], [MoTa], [ThoiLuong], [NgayKhoiChieu], [NgayKetThuc], [SanXuat], [DaoDien], [NamSX]) VALUES (N'P03', N'Exhuma: Quật mộ trùng ma',N'Exhuma: Quat mo trung ma', 100, CAST(N'2024-03-15' AS Date), CAST(N'2024-07-01' AS Date), N'Hàn Quốc', N'Jang Jae Hyun', 2024)
INSERT [dbo].[Phim] ([id], [TenPhim], [MoTa], [ThoiLuong], [NgayKhoiChieu], [NgayKetThuc], [SanXuat], [DaoDien], [NamSX]) VALUES (N'P04', N'Panda đại náo lãnh địa vua sư tử', N'Panda dai nao lanh dia vua su tu', 91, CAST(N'2024-05-03' AS Date), CAST(N'2024-08-01' AS Date), N'Mỹ', N'KARSTEN KIILERICH', 2024)
...
INSERT [dbo].[DinhDangPhim] ([id], [idPhim], [idLoaiManHinh]) VALUES (N'DD02', N'P04', N'MH03')
...
--Lich chiếu
INSERT [dbo].[LichChieu] ([id], [ThoiGianChieu], [idPhong], [idDinhDang], [GiaVe], [TrangThai]) VALUES (N'LC01', CAST(N'2024-02-11T08:50:00.000' AS DateTime), N'PC01', N'DD01', 85000.0000, 1)
INSERT [dbo].[LichChieu] ([id], [ThoiGianChieu], [idPhong], [idDinhDang], [GiaVe], [TrangThai]) VALUES (N'LC02', CAST(N'2024-02-11T09:50:00.000' AS DateTime), N'PC02', N'DD01', 85000.0000, 0)
INSERT [dbo].[LichChieu] ([id], [ThoiGianChieu], [idPhong], [idDinhDang], [GiaVe], [TrangThai]) VALUES (N'LC03', CAST(N'2024-02-11T13:50:00.000' AS DateTime), N'PC01', N'DD01', 85000.0000, 0)
INSERT [dbo].[LichChieu] ([id], [ThoiGianChieu], [idPhong], [idDinhDang], [GiaVe], [TrangThai]) VALUES (N'LC04', CAST(N'2024-02-11T10:50:00.000' AS DateTime), N'PC03', N'DD01', 85000.0000, 0)
INSERT [dbo].[LichChieu] ([id], [ThoiGianChieu], [idPhong], [idDinhDang], [GiaVe], [TrangThai]) VALUES (N'LC05', CAST(N'2024-02-11T22:00:00.000' AS DateTime), N'PC04', N'DD01', 85000.0000, 0)


INSERT [dbo].[LichChieu] ([id], [ThoiGianChieu], [idPhong], [idDinhDang], [GiaVe], [TrangThai]) VALUES (N'LC06', CAST(N'2024-04-30T08:05:00.000' AS DateTime), N'PC01', N'DD01', 85000.0000, 0)
INSERT [dbo].[LichChieu] ([id], [ThoiGianChieu], [idPhong], [idDinhDang], [GiaVe], [TrangThai]) VALUES (N'LC07', CAST(N'2024-04-30T08:05:00.000' AS DateTime), N'PC02', N'DD01', 85000.0000, 0)
INSERT [dbo].[LichChieu] ([id], [ThoiGianChieu], [idPhong], [idDinhDang], [GiaVe], [TrangThai]) VALUES (N'LC08', CAST(N'2024-05-07T08:10:00.000' AS DateTime), N'PC03', N'DD02', 85000.0000, 0)
INSERT [dbo].[LichChieu] ([id], [ThoiGianChieu], [idPhong], [idDinhDang], [GiaVe], [TrangThai]) VALUES (N'LC09', CAST(N'2024-05-04T09:20:00.000' AS DateTime), N'PC04', N'DD03', 85000.0000, 0)
INSERT [dbo].[LichChieu] ([id], [ThoiGianChieu], [idPhong], [idDinhDang], [GiaVe], [TrangThai]) VALUES (N'LC10', CAST(N'2024-05-07T09:20:00.000' AS DateTime), N'PC04', N'DD04', 85000.0000, 0)
INSERT [dbo].[LichChieu] ([id], [ThoiGianChieu], [idPhong], [idDinhDang], [GiaVe], [TrangThai]) VALUES (N'LC11', CAST(N'2024-05-07T09:20:00.000' AS DateTime), N'PC02', N'DD03', 85000.0000, 0)
INSERT [dbo].[LichChieu] ([id], [ThoiGianChieu], [idPhong], [idDinhDang], [GiaVe], [TrangThai]) VALUES (N'LC12', CAST(N'2024-05-07T23:20:00.000' AS DateTime), N'PC02', N'DD03', 85000.0000, 0)
INSERT [dbo].[LichChieu] ([id], [ThoiGianChieu], [idPhong], [idDinhDang], [GiaVe], [TrangThai]) VALUES (N'LC13', CAST(N'2024-05-07T16:20:00.000' AS DateTime), N'PC04', N'DD04', 85000.0000, 0)
