...
namespace GUI.AdminUserControls
{
    public partial class RevenueUC : UserControl
    {
        ...
        void LoadRevenue(string idMovie, DateTime fromDate, DateTime toDate)
        {
            ...
            dtgvRevenue.DataSource = Revenue_DAO.GetRevenue(idMovie, fromDate, toDate);
        ...
        //{
        //    Report frm = new Report(cboSelectMovie.SelectedValue.ToString(), dtmFromDate.Value, dtmToDate.Value);
        //    frm.ShowDialog();
