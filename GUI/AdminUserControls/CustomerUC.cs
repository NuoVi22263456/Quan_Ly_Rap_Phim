...
namespace GUI.AdminUserControls
{
    public partial class CustomerUC : UserControl
    {
        ...
        {
            customerList.DataSource = Customer_DAO.GetListCustomer();
        }
        ...
        {
            if (Customer_DAO.InsertCustomer(id, hoTen, ngaySinh, diaChi, sdt, cmnd))
            {
        ...
        {
            if (Customer_DAO.UpdateCustomer(id, hoTen, ngaySinh, diaChi, sdt, cmnd, point))
            {
        ...
        {
            if (Customer_DAO.DeleteCustomer(id))
            {
        ...
        private void btnSearchCus_Click(object sender, EventArgs e)
        {
            ...
            customerList.DataSource = Customer_DAO.SearchCustomerByName(cusName);
        }
