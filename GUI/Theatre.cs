...
namespace GUI
{
    public partial class Theatre : Form
    {
        ...
        List<Ticket_DTO> listSeat = new List<Ticket_DTO>();
        ...
        Customer_DTO customer;//lưu lại khách hàng thành viên

        ShowTimes_DTO Times;
        Movie_DTO Movie;

        public Theatre(ShowTimes_DTO showTimes, Movie_DTO movie)
        {
            InitializeComponent();
        ...
        private void frmTheatre_Load(object sender, EventArgs e)
        {
            ...
            lblInformation.Text = "CGV Gò Vấp | " + Times.CinemaName + " | " + Times.MovieName;
            ...
            listSeat = Ticket_DAO.GetListTicketsByShowTimes(Times.ID);
        ...
        {
            Cinema_DTO cinema = Cinema_DAO.GetCinemaByName(cinemaName);
            int Row = cinema.Row;
        ...
        private void LoadSeats(List<Ticket_DTO> list)
        {
        ...
        private void BtnSeat_Click(object sender, EventArgs e)
        {
            ...
            if (btnSeat.BackColor == Color.White)
            {
                ...
                Ticket_DTO ticket = btnSeat.Tag as Ticket_DTO;
        ...
        private void btnPayment_Click(object sender, EventArgs e)
        {
            ...
            if (result == DialogResult.OK)
            {
                ...
                if (chkCustomer.Checked == true)
                {
                    foreach (Button btn in listSeatSelected)
                    {
                        Ticket_DTO ticket = btn.Tag as Ticket_DTO;

                        ret += Ticket_DAO.BuyTicket(ticket.ID, ticket.Type, customer.ID, ticket.Price);
                    }
                    customer.Point += plusPoint;
                    Customer_DAO.UpdatePointCustomer(customer.ID, customer.Point);
                }
                else
                {
                    foreach (Button btn in listSeatSelected)
                    {
                        ...
                        ret += Ticket_DAO.BuyTicket(ticket.ID, ticket.Type, ticket.Price);
                    }
                }
        ...
        private void rdoStudent_Click(object sender, EventArgs e)
        {
            if (rdoStudent.Checked == true)
            {
                ...
                Ticket_DTO ticket = listSeatSelected[listSeatSelected.Count - 1].Tag as Ticket_DTO;
                ticket.Type = 2;
        ...
        private void btnFreeTicket_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (result == DialogResult.Yes)
                {
                    ...
                    if (Customer_DAO.UpdatePointCustomer(customer.ID, customer.Point))
                    {
                    ...
                    {
                        Ticket_DTO ticket = listSeatSelected[i].Tag as Ticket_DTO;
                        if (ticket.Price != 0)
                        {
